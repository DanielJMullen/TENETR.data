...
#'   \item{\code{start}}{integer COLUMN_DESCRIPTION}
#'   \item{\code{end}}{integer COLUMN_DESCRIPTION}
#'   \item{\code{width}}{integer COLUMN_DESCRIPTION}
#'   \item{\code{strand}}{character COLUMN_DESCRIPTION}
#'   \item{\code{source}}{character COLUMN_DESCRIPTION}
#'   \item{\code{type}}{character COLUMN_DESCRIPTION}
#'   \item{\code{score}}{character COLUMN_DESCRIPTION}
#'   \item{\code{phase}}{integer COLUMN_DESCRIPTION}
#'   \item{\code{gene_id}}{character COLUMN_DESCRIPTION}
...
#'   \item{\code{CpG_beg}}{integer COLUMN_DESCRIPTION}
#'   \item{\code{CpG_end}}{integer COLUMN_DESCRIPTION}
#'   \item{\code{CpG_beg_TRUE}}{integer COLUMN_DESCRIPTION}
#'   \item{\code{CpG_end_TRUE}}{integer COLUMN_DESCRIPTION}
#'   \item{\code{probe_strand}}{character COLUMN_DESCRIPTION}
#'   \item{\code{probeID}}{character COLUMN_DESCRIPTION}
