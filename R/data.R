#' Consensus enhancer regions dataset
#' 
#' A dataset containing consensus enhancer regions for numerous cell types annotated to the hg38 human genome. Based on 18-state chromHMM annotations from 98 cell types and 112 eRNA datasets.
#' 
...
#' 
#' GENCODE v22 .gtf file
#' 
#' A dataset containing information for the GENCODE v22 (GRCh38.p2) .gtf file loaded using tracklayer's import function
#' 
...
#' 
#' Consensus open chromatin regions dataset
#' 
#' A dataset containing a master track of DNaseI hypersensitive sites from 125 seperate cell types from ENCODE lifted from the hg19 to the hg38 human genome. 
#' 
